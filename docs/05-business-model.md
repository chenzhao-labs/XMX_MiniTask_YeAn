...
| **AI 会员（核心）** | 29.9元/月 | 深度周报 + 无限对话 + 多源数据接入 |

### 3.2 定价逻辑

1. **硬件 199 元**：处于"无需家庭会议即可决策"的冲动消费区间
2. **基础免费**：降低尝试门槛，让"跌倒报警"这个核心安全功能人人可享
3. **会员 29.9 元/月**：对标一杯奶茶/一次打车，远低于保健品支出

### 3.3 单位经济模型（UE）

```
单用户首年收入 = 199（硬件）+ 29.9×12（会员）= 557.8 元
单用户首年成本 = 85（BOM）+ 0.6×12（AI）+ 25（获客摊销）= 117.2 元
单用户首年毛利 = 440.6 元
毛利率 ≈ 78.9%
```
...
「夜安」持续积累的老人**行为健康数据**（作息规律性、活动能力趋势、夜间异常频率），构成了一个独特的**适老化风控数据维度**。
